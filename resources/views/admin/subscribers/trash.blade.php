            ...
            <div class="box">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <table><tr>
                                <td> <form action="{{env('APP_URL').'/admin/subscribers_recover'}}" method="post">
                                        @csrf
                                ...
                                <td> <form action="{{env('APP_URL').'/admin/subscribers_recover'}}" method="post">
                                        ...
                                        <button title="{{__('admin.delete_all')}}?" onclick="return confirm('{{__('admin.are_you_sure')}}')"
                    ...
                    <table id="example1" class="table table-bordered table-striped">
                        ...
                        @foreach($trash as $item)
                            <tr>
                                ...
                                <td>
                                    <form action="{{env('APP_URL').'/admin/subscribers_recover'}}" method="post">
                                        @csrf
