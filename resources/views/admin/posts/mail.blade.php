...
@section('text')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- Default box -->
            <div class="box">
                <form action="{{env('APP_URL').'/admin/sendMail'}}" method="post">
                    ...
                    <div class="box-body">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$email}}" name="email">
                            </div>
                            <div class="form-group">
                                <label for="exampleInputEmail1"> {{__('admin.title')}}</label>
                                <input type="text" class="form-control" id="exampleInputEmail1" placeholder="" value="{{$title}}" name="title">
                            </div>
                            <div class="form-group">
                                @csrf
                    ...
                    <div class="box-footer">
                        ...
                        <input type="submit" class="btn btn-success pull-right" name="submit" value=" {{__('admin.back')}}">
                    </div>
                </form>       <!-- /.box-footer-->
            </div>
            <!-- /.box -->
