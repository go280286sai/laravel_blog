...
return [
    ...
    'no_tags' => 'Нет тегов',
    'check_your_mailbox' => 'Проверьте Ваш почтовый ящик',
    'invalid_mail_entered' => 'Не верно введена почта',
    'write_comment' => 'Написать комментарий',
    'write_text' => 'Написать текст',
    'invalid_entered' => 'Некорректно заполнено',
    'blog_title' => 'Блог о новых технологиях и возможностях',
    'dear_user' => 'Уважаемый пользователь!',
    'dear_subs' => 'Уважаемый подписчик!',
    'click_to_ref' => 'Для подтверждения качества ссылки',
